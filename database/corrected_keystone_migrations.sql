-- =====================================================
-- CORRECTED KEYSTONE MIGRATIONS FOR CUSTOMSHOP
-- Fixed to match actual profiles table structure
-- =====================================================
...
-- Create views for common queries - CORRECTED VERSION
...
-- CORRECTED VIEW - Using actual column names from profiles table
...
GROUP BY o.id, p.email, p.first_name, p.last_name;
